...
Nachdem das Training und das Testen abgeschlossen ist, kann das Ergebnis ausgewertet werden. Dazu muss das Skript evaluate.py aufgerufen werden. Dies geschieht über
